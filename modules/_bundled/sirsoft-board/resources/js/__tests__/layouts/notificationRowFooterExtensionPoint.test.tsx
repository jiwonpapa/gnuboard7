...
/**
 * 게시판 알림 정의 행 하단 확장 슬롯(notification_definition_row_footer) 위치 회귀 가드
 *
 * @description
...
import tab from '../../../layouts/admin/partials/admin_board_settings/_tab_notification_definitions.json';
...
describe('게시판 알림 행 footer extension_point 위치', () => {
