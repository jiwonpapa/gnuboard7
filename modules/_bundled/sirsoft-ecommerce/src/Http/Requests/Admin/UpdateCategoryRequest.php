    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'parent_id' => [
                ...
                new NotCircularCategoryParent($categoryId !== null ? (int) $categoryId : null),
            ],
            'slug' => [
                'required',
                'string',
        ...
        // 훅을 통한 동적 규칙 확장
        return HookManager::applyFilters('sirsoft-ecommerce.category.update_validation_rules', $rules, $this);
    }
