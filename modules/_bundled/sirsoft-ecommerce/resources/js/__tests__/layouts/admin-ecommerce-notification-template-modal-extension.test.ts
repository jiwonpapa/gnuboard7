...
/**
 * 이커머스 알림 템플릿 편집 모달 — 확장 슬롯 2종 + hidden_template_editor 게이트 (코어 admin_basic 모달과 동형, 면 식별자만 다름)
 *
...
import modal from '../../../layouts/admin/partials/admin_ecommerce_settings/_modal_notification_template_edit.json';

type Node = Record<string, any>;
const PREFIX = 'ecommerce_';
const STATE_KEY = 'ecommerce_notification_template_form_modal';
const MODAL_ID = 'modal_ecommerce_notification_template_edit';
const REFETCH_ID = 'ecommerceNotificationDefinitions';
...
describe('이커머스 알림 템플릿 편집 모달 — 확장 슬롯 2종', () => {
...
describe('이커머스 알림 템플릿 편집 모달 — hidden_template_editor 게이트 실평가', () => {
