...
class NotificationController extends AdminBaseController
{
    ...
    public function index(NotificationIndexRequest $request): JsonResponse
    {
        try {
            ...
            Log::error('관리자 알림 목록 조회 실패', ['error' => $e->getMessage()]);
    ...
    public function unreadCount(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('관리자 미읽음 알림 수 조회 실패', ['error' => $e->getMessage()]);
    ...
    public function markAsRead(Request $request, string $id): JsonResponse
    {
        try {
            ...
            Log::error('관리자 알림 읽음 처리 실패', ['id' => $id, 'error' => $e->getMessage()]);
    ...
    public function markBatchAsRead(NotificationBatchReadRequest $request): JsonResponse
    {
        try {
            ...
            Log::error('관리자 알림 일괄 읽음 처리 실패', ['error' => $e->getMessage()]);
    ...
    public function markAllAsRead(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('관리자 전체 읽음 처리 실패', ['error' => $e->getMessage()]);
    ...
    public function destroyAll(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('관리자 전체 알림 삭제 실패', ['error' => $e->getMessage()]);
    ...
    public function destroy(Request $request, string $id): JsonResponse
    {
        try {
            ...
            Log::error('관리자 알림 삭제 실패', ['id' => $id, 'error' => $e->getMessage()]);
