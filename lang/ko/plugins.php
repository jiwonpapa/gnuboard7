...
return [
    ...
    'list_failed' => '플러그인 목록을 가져오는데 실패했습니다: :error',
    'fetch_success' => '플러그인 정보를 성공적으로 가져왔습니다.',
    'fetch_failed' => '플러그인 정보를 가져오는데 실패했습니다: :error',
    ...
    'install_validation_failed' => '플러그인 설치 검증에 실패했습니다: :error',
    'install_error' => '플러그인 설치 중 오류가 발생했습니다.',
    'uninstall_success' => '플러그인이 성공적으로 제거되었습니다.',
    'uninstall_failed' => '플러그인 제거에 실패했습니다: :error',
    'uninstall_validation_failed' => '플러그인 제거 검증에 실패했습니다: :error',
    'uninstall_error' => '플러그인 제거 중 오류가 발생했습니다.',
    'activate_success' => '플러그인이 성공적으로 활성화되었습니다.',
    'activate_failed' => '플러그인 활성화에 실패했습니다: :error',
    'activate_validation_failed' => '플러그인 활성화 검증에 실패했습니다: :error',
    'activate_error' => '플러그인 활성화 중 오류가 발생했습니다.',
    'deactivate_success' => '플러그인이 성공적으로 비활성화되었습니다.',
    'deactivate_failed' => '플러그인 비활성화에 실패했습니다: :error',
    'deactivate_validation_failed' => '플러그인 비활성화 검증에 실패했습니다: :error',
    ...
    'uninstall_info_failed' => '플러그인 삭제 정보 조회에 실패했습니다: :error',
    ...
    'refresh_layouts_validation_failed' => '플러그인 레이아웃 갱신 검증에 실패했습니다: :error',
    ...
    'update_hook_failed' => '플러그인 업데이트 훅 실행에 실패했습니다: :error',
    ...
    'move_failed' => '플러그인 ":plugin" 이동에 실패했습니다: :error',
    ...
    'errors' => [
        ...
        'layout_validation_validation_failed' => '플러그인 :identifier의 레이아웃 검증에 실패했습니다. :count개의 오류가 발견되었습니다: :error',
        'operation_in_progress' => '플러그인 ":name"이(가) 현재 :status 상태입니다. 작업이 완료될 때까지 기다려 주세요.',
        'github_api_failed' => 'GitHub API 호출에 실패했습니다: :error',
        'invalid_github_url' => '유효하지 않은 GitHub URL입니다.',
        'zip_url_not_found' => 'ZIP 다운로드 URL을 찾을 수 없습니다.',
        'download_failed' => '플러그인 ":plugin" :version 버전 다운로드에 실패했습니다: :error',
        'zip_extract_failed' => 'ZIP 압축 해제에 실패했습니다: :error',
        'extracted_dir_not_found' => '압축 해제된 디렉토리를 찾을 수 없습니다.',
        'reload_failed' => '플러그인 다시 로드에 실패했습니다: :error',
        'delete_directory_failed' => '플러그인 디렉토리 삭제에 실패했습니다: :error',
        ...
        'github_download_failed' => 'GitHub에서 다운로드에 실패했습니다: :error',
    ...
    // 플러그인 설정 관련 메시지
    'settings' => [
        'update_failed' => '플러그인 설정 업데이트에 실패했습니다: :error',
