...
return [
    ...
    'list_failed' => 'Failed to retrieve plugin list: :error',
    'fetch_success' => 'Plugin information retrieved successfully.',
    'fetch_failed' => 'Failed to retrieve plugin information: :error',
    'not_found' => 'Plugin :plugin not found.',
    'install_success' => 'Plugin installed successfully.',
    'install_failed' => 'Failed to install plugin: :error',
    'preview_success' => 'Manifest preview completed.',
    'preview_failed' => 'Failed to preview manifest: :error',
    'install_validation_failed' => 'Plugin installation validation failed: :error',
    'install_error' => 'An error occurred while installing plugin.',
    'uninstall_success' => 'Plugin uninstalled successfully.',
    'uninstall_failed' => 'Failed to uninstall plugin: :error',
    'uninstall_validation_failed' => 'Plugin uninstallation validation failed: :error',
    ...
    'activate_validation_failed' => 'Plugin activation validation failed: :error',
    ...
    'deactivate_validation_failed' => 'Plugin deactivation validation failed: :error',
    ...
    'uninstall_info_failed' => 'Failed to retrieve plugin uninstall information: :error',
    ...
    'refresh_layouts_validation_failed' => 'Plugin layouts refresh validation failed: :error',
    ...
    'update_hook_failed' => 'Plugin update hook execution failed: :error',
    ...
    'move_failed' => 'Failed to move plugin ":plugin": :error',
    ...
    'errors' => [
        ...
        'layout_validation_validation_failed' => 'Layout validation failed for plugin :identifier. :count error(s) found: :error',
        ...
        'download_failed' => 'Failed to download plugin ":plugin" version :version: :error',
        'zip_extract_failed' => 'ZIP extraction failed: :error',
        'extracted_dir_not_found' => 'Extracted directory not found.',
        'reload_failed' => 'Failed to reload plugin: :error',
        'delete_directory_failed' => 'Failed to delete plugin directory: :error',
        ...
        'zip_open_failed' => 'Unable to open ZIP file: :error',
    ...
    'settings' => [
        'update_failed' => 'Failed to update plugin settings: :error',
