...
namespace Plugins\Sirsoft\PayNhnkcp\Tests\Unit\Extensions;
...
class AdminOrderListColumnSnapshotTest extends TestCase
{
    ...
    private const EXTENSION_PATH = 'plugins/_bundled/sirsoft-pay_nhnkcp/resources/extensions/admin_order_list_test_badge.json';
