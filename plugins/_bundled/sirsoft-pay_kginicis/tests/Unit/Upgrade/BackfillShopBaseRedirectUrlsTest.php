...
namespace Plugins\Sirsoft\PayKginicis\Tests\Unit\Upgrade;

use App\Upgrades\Data\Ext\Plugins\SirsoftPayKginicis\V1_1_0\Migrations\BackfillShopBaseRedirectUrls;
...
class BackfillShopBaseRedirectUrlsTest extends PluginTestCase
{
    protected function setUp(): void
    {
        ...
        require_once base_path('plugins/_bundled/sirsoft-pay_kginicis/upgrades/data/1.1.0/migrations/BackfillShopBaseRedirectUrls.php');
    }
