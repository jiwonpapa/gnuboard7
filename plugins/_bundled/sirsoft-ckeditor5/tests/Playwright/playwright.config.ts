/**
 * CKEditor5 플러그인 Playwright E2E 설정.
 *
...
const ARTIFACT_SLUG = 'plugins/sirsoft-ckeditor5';
...
function resolveBaseUrl(): string {
  ...
  throw new Error(
    'CKEditor5 플러그인 E2E base URL 미설정. PLAYWRIGHT_BASE_URL 환경변수를 지정하거나 코어 .env 의 APP_URL 을 활성 호스트로 설정하세요.'
  );
}
