...
const logger = ((window as any).G7Core?.createLogger?.('Comp:ImageGallery')) ?? {
    log: (...args: unknown[]) => console.log('[Comp:ImageGallery]', ...args),
    warn: (...args: unknown[]) => console.warn('[Comp:ImageGallery]', ...args),
    error: (...args: unknown[]) => console.error('[Comp:ImageGallery]', ...args),
};
